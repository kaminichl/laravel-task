	  ...
	  <h5>Welcome!</h5>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          ...
          <div class="navbar-text"> 
			...
			@if(Auth::guest())
				<a href="{{ url('/register') }}" class="btn btn-primary navbar-btn btn-shadow btn-gradient">Register</a>
				<a href="{{ url('/login') }}" class="btn btn-success navbar-btn btn-shadow btn-gradient">Login</a>
			@else 
				@if(Auth::user()->isAdmin()) 
					<a href="{{ url('/backend') }}" class="btn btn-dangerbtn-shadow btn-gradient">Backend</a>
				@endif
				<a href="{{ url('/logout') }}" class="btn btn-dangerbtn-shadow btn-gradient">Logout</a>
			@endif
